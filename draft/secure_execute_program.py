...
def start_program(program: str, stdin: str = '', language: str = 'python', \
    ...
    if language == 'python':
        stdout, stderr, status_code = execute_python_proram(program, stdin, cpu, memory, timeout)
        return (stdout, stderr, status_code)
    elif language == 'cpp':
        _, stdout, stderr, status_code = execute_cpp_proram(program, stdin, cpu, memory, timeout)
        return (stdout, stderr, status_code)
